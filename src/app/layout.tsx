...
export const metadata: Metadata = {
  title: "Zain Shah",
  description:
    "Zain Shah is a proficient Software Engineer and Full Stack Developer from Pakistan, skilled in front-end and back-end development using modern tech stacks.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
